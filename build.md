...
- [Inno Setup](http://www.jrsoftware.org/isdl.php) の以下のいずれかのバージョンです。(`CI`は最新バージョンを使用しています)
  - <del>Inno Setup 5</del>(互換性がありません)
  - [innosetup-6.1.2.exe](https://files.jrsoftware.org/is/6/innosetup-6.1.2.exe)
